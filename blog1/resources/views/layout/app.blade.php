...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset ('assests/vendor/daterangepicker/daterangepicker.css') }}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset ('assets/vendor/slick/slick.css') }}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset ('assests/vendor/lightbox2/css/lightbox.min.css') }}">
<!--===============================================================================================-->
	...
	<header class="header1">
		...
		<div class="container-menu-header">
			<div class="topbar">
				...
				Welcome to the Laravel Tasks
				</span>

				<div class="topbar-child2">
					<span class="topbar-email">
					testuser@kcsitglobal.com
					</span>
				</div>
			</div>
			...
			<div class="wrap_header">
				...
				<a href="index.html" class="logo">
					<img src="{{ asset('assets/images/icons/kcslogo.jpg') }}" alt="IMG-LOGO"  >
				</a>
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{{asset('assests/images/item-cart-02.jpg')}}" alt="IMG">
									</div>
